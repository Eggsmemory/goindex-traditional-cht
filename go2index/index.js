 ...
 * @param gd
 * @returns {Promise<Response>} 【注意】如果從前台接收的id代表的項目不在目標gd盤下，那麽response會返回給前台一個空字符串""
 */
...
class googleDrive {
   ...
   * 只考慮一條單獨的向上鏈。
   * 【注意】如果此id代表的項目不在目標gd盤下，那麽此函數會返回null
   *
   * @param child_id
   ...
   * 獲取相對於本盤根目錄的path
   * @param child_id
   * @returns {Promise<string>} 【注意】如果此id代表的項目不在目標gd盤下，那麽此方法會返回空字符串""
   */
